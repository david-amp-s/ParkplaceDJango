...
def export_report_pdf(request):
    ...
    # BLINDAJE TOTAL: Convertimos cualquier None en 0 o lista vacía
    context = {
        "finanzas": {
            ...
            "tickets_hoy": finanzas_raw.get('tickets_hoy') or 0,
        },
        "horas_pico": horas_pico_raw,
        "stay_avg": stay_metrics_raw.get('avg_time') or 0,
        "stay_max": stay_metrics_raw.get('max_time') or 0,
        "vehicle_stats": vehicle_stats_raw,
        "hoy": date.today(),
    }
    
    # Importante: Asegúrate de que el nombre del archivo sea exacto
