...
from datetime import date
from .repositories import DjangoReportRepository
from .utils import render_to_pdf # La función que creamos antes
...
def export_report_pdf(request):
    ...
    # BLINDAJE: Si no hay datos, enviamos 0 en lugar de None
    context = {
        "finanzas": {
            "hoy": finanzas.get('hoy') or 0,
            "semana": finanzas.get('semana') or 0,
            "mes": finanzas.get('mes') or 0,
            "tickets_hoy": finanzas.get('tickets_hoy') or 0,
        },
        "horas_pico": horas_pico or [], # Lista vacía si no hay nada
