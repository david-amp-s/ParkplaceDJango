...
def export_report_pdf(request):
    ...
    # Obtenemos la ruta de la carpeta 'infrastructure' donde está este archivo views.py
    ...
    context = {
        ...
        "hoy": date.today(),
        "logo_path": path_al_logo # Ahora enviamos la ruta física real
    }
