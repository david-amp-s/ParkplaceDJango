...
def export_report_pdf(request):
    ...
    context = {
        ...
        "hoy": date.today(),
        "logo_base64": logo_base64  # <--- Enviamos el texto de la imagen
    }
