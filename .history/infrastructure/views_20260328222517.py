...
def export_report_pdf(request):
    ...
    # 1. Obtenemos datos y aseguramos que sean diccionarios o listas, nunca None
    ...
    # 2. Limpieza de Finanzas (Evita el error '>' entre None y None)
    finanzas = {
    ...
    # 3. Limpieza de Estadísticas
    context = {
        "finanzas": finanzas,
        "horas_pico": list(horas_pico_raw), # Forzamos a lista por si es un QuerySet vacío
    ...
    # Asegúrate de que el nombre del template coincida con el archivo físico
