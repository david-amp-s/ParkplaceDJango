...
def export_report_pdf(request):
    ...
    # --- LIMPIEZA AGRESIVA ---
    # Aseguramos que si algo es None, pase como 0 o lista vacía
    finanzas = {
    ...
    # Aseguramos que las listas no sean None
    horas_pico = horas_pico_raw if horas_pico_raw is not None else []
    vehicle_stats = vehicle_stats_raw if vehicle_stats_raw is not None else []
