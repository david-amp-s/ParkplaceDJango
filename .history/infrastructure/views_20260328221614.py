...
from .utils import render_to_pdf # Importa la función que creamos
...
def export_report_pdf(request):
    ...
    finanzas = repo.get_financial_summary()
    # ... (Copia aquí toda la lógica de obtención de datos de tu reports_view) ...
    
    context = {
        "finanzas": finanzas,
        "hoy": date.today(),
        # ... (Pasa todo el mismo diccionario context) ...
    }
    
    # Creamos el PDF usando el mismo HTML (o una versión simplificada)
    pdf = render_to_pdf('reports.html', context)
    
    # Esto fuerza la descarga en el navegador
    response = HttpResponse(pdf, content_type='application/pdf')
    filename = f"Reporte_ParkPlace_{date.today()}.pdf"
