...
def reports_dashboard(request):
    ...
    # =========================
    # VALIDACIONES (EVITA CRASH)
    # =========================
    daily_income = daily_income or {"total": 0, "ticket_count": 0}
    monthly_income = monthly_income or []
    vehicle_stats = vehicle_stats or []
    frequent_clients = frequent_clients or []
    ...
    # KPI: PROMEDIO TICKET
    # =========================
    average_ticket = total_income / total_tickets if total_tickets > 0 else 0
    ...
    context = {
        ...
        "top_revenue_days": monthly_income,
