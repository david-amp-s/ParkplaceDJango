...
def reports_dashboard(request):
    """
    Módulo de reportes enfocado en análisis histórico.
    No duplica el dashboard.
    """
    ...
    context = {
        ...
        # ANÁLISIS FINANCIERO
        # ======================
        "revenue_trend": uc.get_revenue_trend(selected_year, selected_month),
        "monthly_comparison": uc.get_monthly_comparison(selected_year, selected_month),
        "average_ticket": uc.get_average_ticket_value(selected_year, selected_month),
        "top_revenue_days": uc.get_top_revenue_days(selected_year, selected_month),

        # ======================
        # OPERACIÓN DEL PARQUEADERO
        # ======================
        "occupancy_rate": uc.get_average_occupancy(selected_year, selected_month),
        "average_stay_time": uc.get_average_stay_time(selected_year, selected_month),

        # ======================
        # CLIENTES
        # ======================
        "client_type_stats": uc.get_client_retention_stats(selected_year, selected_month),
        "frequent_clients_report": uc.get_frequent_clients(limit=10),

        # ======================
        # VEHÍCULOS (ANÁLISIS)
        # ======================
        "income_by_vehicle_type": uc.get_income_by_vehicle_type(selected_year, selected_month),
    }
